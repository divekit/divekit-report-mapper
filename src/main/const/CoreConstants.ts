...
export const CODE_PRINCIPLES = [
    CLEAN_CODE_PRINCIPLE.KISS,
    CLEAN_CODE_PRINCIPLE.LA,
    CLEAN_CODE_PRINCIPLE.IH,
    CLEAN_CODE_PRINCIPLE.DRY,
    CLEAN_CODE_PRINCIPLE.SLA,
    CLEAN_CODE_PRINCIPLE.YAGNI,
    CLEAN_CODE_PRINCIPLE.NAMES,
    CLEAN_CODE_PRINCIPLE.COMMENTS,
    CLEAN_CODE_PRINCIPLE.TESTS,
    SOLID_PRINCIPLE.SRP,
    SOLID_PRINCIPLE.OCP
]
